...
BOOST_AUTO_TEST_CASE(AlertApplies)
{
    ...
    // Paris: TODO: sign alerts with Paris key
...
//    }
    ...
    // Matches:
    // Paris: for some bitcoin test alerts are read with nExpiration == 0, making following tests fail.
...
BOOST_AUTO_TEST_CASE(AlertNotify)
{
    ...
    // Paris: following tests requires alertnotify.txt to exist, but for some reason this file is deleted at next instruction...
